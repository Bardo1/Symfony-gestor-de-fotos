...
class appDevDebugProjectContainer extends Container
{
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_sqlite', 'host' => 'www.bardo1.com', 'port' => NULL, 'dbname' => 'symfony.db', 'user' => 'root', 'password' => NULL, 'charset' => 'UTF8', 'path' => ($this->targetDirs[2].'/symfony.db'), 'driverOptions' => array()), $b, new \Symfony\Bridge\Doctrine\ContainerAwareEventManager($this), array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $b = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($a, array(0 => ($this->targetDirs[3].'/src/walter/pruebaBundle/Entity'), 1 => ($this->targetDirs[3].'/src/walter/alumnosBundle/Entity')));

        $c = new \Doctrine\Common\Persistence\Mapping\Driver\MappingDriverChain();
        $c->addDriver($b, 'walter\\pruebaBundle\\Entity');
        $c->addDriver($b, 'walter\\alumnosBundle\\Entity');

        $d = new \Doctrine\ORM\Configuration();
        $d->setEntityNamespaces(array('walterpruebaBundle' => 'walter\\pruebaBundle\\Entity', 'walteralumnosBundle' => 'walter\\alumnosBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_0b69717f74b8e5a7da243b9510aee5621af725711ade2b19bc62faefacc34963');
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'/src/walter/pruebaBundle/Resources/views'), 'walterprueba');
        $instance->addPath(($this->targetDirs[3].'/src/walter/alumnosBundle/Resources/views'), 'walteralumnos');
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'walterpruebaBundle' => 'walter\\pruebaBundle\\walterpruebaBundle',
                'walteralumnosBundle' => 'walter\\alumnosBundle\\walteralumnosBundle',
